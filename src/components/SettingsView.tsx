...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  const liveVietQrUrl = useMemo(() => {
    ...
    return generateVietQrUrl({
      ...
      memo: `${formData.defaultMemoPrefix || 'TRA NO'} NGUYEN VAN A`,
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-4 pb-12 animate-in fade-in duration-150">
      {/* Page Header */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 bg-slate-100/90 p-1.5 rounded-2xl border border-slate-200/80">
        <button
          ...
          className={`px-3 py-2.5 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer outline-none focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 ${
            activeTab === 'BANK'
        ...
        >
          ...
          <span className="truncate">1. Ngân Hàng &amp; VietQR</span>
        </button>

        <button
          type="button"
          onClick={() => setActiveTab('CLOUD')}
          className={`px-3 py-2.5 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer outline-none focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 ${
            activeTab === 'CLOUD'
        ...
        >
          ...
          <span className="truncate">2. Đám Mây &amp; Sao Lưu</span>
        </button>

        <button
          type="button"
          onClick={() => setActiveTab('TEXTS')}
          className={`px-3 py-2.5 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all cursor-pointer outline-none focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 ${
            activeTab === 'TEXTS'
        ...
        >
          ...
          <span className="truncate">3. Lời Nhắn &amp; Mẫu Tin</span>
        </button>
      </div>
              ...
              <div className="lg:col-span-7 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={formData.defaultMemoPrefix || 'TRA NO'}
                      onChange={(e) =>
                        setFormData({
                          ...formData,
                    ...
                    <p className="text-[11px] text-slate-500 mt-1">
                      Nội dung QR: <code className="text-emerald-700 font-bold">{formData.defaultMemoPrefix || 'TRA NO'} [TÊN KHÁCH]</code>
                    </p>
                  </div>
                    ...
                    <div className="bg-white p-3.5 rounded-2xl border border-slate-200 space-y-2 text-xs">
                      ...
                      <div className="flex items-center justify-between pt-1 border-t border-slate-100">
                        ...
                        <span className="font-mono text-emerald-700 font-bold text-[11px]">
                          {formData.defaultMemoPrefix || 'TRA NO'} [TÊN KHÁCH]
                        </span>
                      </div>
                    </div>
                  </div>
